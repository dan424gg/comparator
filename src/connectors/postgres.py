...
class PostgresConnector(Connector):
    def __init__(self, username: str, password: str, host: str, database: str, port: int = 5432):
        self.conn_str = f"postgresql+psycopg2://{username}:{password}@{host}:{port}/{database}"
